...
const storeStory1 = new Store({
    HTML: '<p>Simple text</p>'
})

export const Story1 = () => {
    return (
        <State store={storeStory1}>
            <Editor
                HTML={storeStory1.get('HTML')}
                onHTMLEdit={HTML => {
                    storeStory1.set({ HTML });
                    console.log('Update state', storeStory1.get('HTML'));
                }}
            />
        </State>
    )
...
export const Story2 = () => {
    const testHTML = '<div><span style="color: blue">Simple HTML</span></div>';
    return (
        <Editor
            HTML={testHTML}
